...
# Middleman signature
middleman_signature = crypto.generate_signature(message_data, middleman_private_key)
...
unverification = crypto.verify_signature(message_data, middleman_signature, sender_public_key)
